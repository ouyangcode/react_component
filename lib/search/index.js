  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        searchKey.length > 0 && loaded ? _react2.default.createElement(SearchResultList, { dataList: dataList, listItem: listItem, searchKey: searchKey, noResult: noResult, content: content, loaded: loaded, onClick: this.handleClick.bind(this), onScroll: this.handleScroll.bind(this) }) : _react2.default.createElement('div', null),
...
var SearchResultList = function SearchResultList(_ref) {
  ...
  if (dataList && dataList.length > 0) {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'dataList', onScroll: function onScroll() {
            _onScroll();
          } },
        _react2.default.createElement(
          'ul',
