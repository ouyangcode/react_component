...
var Supplier = function (_Component) {
  _inherits(Supplier, _Component);

  function Supplier(props) {
    _classCallCheck(this, Supplier);

    var _this = _possibleConstructorReturn(this, (Supplier.__proto__ || Object.getPrototypeOf(Supplier)).call(this, props));
  ...
  _createClass(Supplier, [{
    ...
    value: function componentWillMount() {
      ...
      var categoryCode = this.props.categoryCode;

      services.map(function (item, index) {
        if (item.categoryCode === categoryCode) {
          _this2.setState({ currentServer: item }, function () {
            _this2.getBrandLength();
          });
        }
      });
    }
    ...
    key: 'getBrandLength',
    value: function getBrandLength() {
      var brands = this.state.currentServer.brands;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        brands && brands.length > 1 ? _react2.default.createElement(
          'div',
          null,
          ...
          _react2.default.createElement('span', { className: 'underLine', style: { width: unitWidth + '%', left: chooseIndex * unitWidth + '%' } })
        ) : ''
      );
    }
  }]);
