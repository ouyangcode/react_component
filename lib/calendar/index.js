...
var MyCalendar = function (_Component) {
	...
	function MyCalendar(props) {
		...
		var pricearr = props.pricearr,
		    ...
		    DefaultnoUse = props.DefaultnoUse;
		...
		_this.handleCustomClick = _this.handleCustomClick.bind(_this);
		return _this;
	}
	...
	_createClass(MyCalendar, [{
		...
		value: function handleCustomClick(month, item) {
			console.log('item----', month, item);
			var _state = this.state,
			    CustomClick = _state.CustomClick,
			    startTimeClick = _state.startTimeClick,
			    endTimeClick = _state.endTimeClick;
		...
		value: function render() {
			var _state2 = this.state,
			    dateList = _state2.dateList,
			    pricearr = _state2.pricearr,
			    handlePriceData = _state2.handlePriceData,
			    CustomClick = _state2.CustomClick,
			    DefaultnoUse = _state2.DefaultnoUse;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'calendar' },
						_react2.default.createElement(Calendar, { dateList: dateList, handleClickfn: this.handleClickfn, CustomClick: CustomClick, handleCustomClick: this.handleCustomClick, DefaultnoUse: DefaultnoUse })
					)
				)
			);
		}
...
var Calendar = function Calendar(_ref2) {
	var dateList = _ref2.dateList,
	    ...
	    CustomClick = _ref2.CustomClick,
	    handleCustomClick = _ref2.handleCustomClick,
	    DefaultnoUse = _ref2.DefaultnoUse;
						...
						return _react2.default.createElement(
							...
							{ className: 'itemList', key: 'key' + index, onClick: function onClick() {
									items2.price ? handleClickfn(items2.price, items2.date, items2.datestr) : '';{
										CustomClick === 'true' ? handleCustomClick(item.month, items2) : '';
									}
								} },
							_react2.default.createElement(
								'span',
								{ className: '' + (items2.price ? '' : DefaultnoUse === 'nouse' ? 'itemspan' : item.month == mm && items2.day < dd ? 'itemspan' : '') },
								items2.day
							),
							_react2.default.createElement(Addcalendar, { addData: items2.price ? '￥' + items2.price : items2.cn, calendarName: items2.price ? 'priceCalendar' : DefaultnoUse === 'nouse' ? 'addCalendar itemspan' : item.month == mm && items2.day < dd ? 'addCalendar itemspan' : 'addCalendar' })
						);
					}),
