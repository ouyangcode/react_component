...
var CustomerList = function (_Component) {
  ...
  function CustomerList(props) {
    ...
    var _this = _possibleConstructorReturn(this, (CustomerList.__proto__ || Object.getPrototypeOf(CustomerList)).call(this, props));
  ...
  _createClass(CustomerList, [{
    ...
    value: function fetchContact() {
      ...
      var userId = (0, _getStore2.default)('customerUserId', 'session');
      (0, _get2.default)('/user/v1/contacts', { userId: userId }).then(function (_ref) {
        var code = _ref.code,
            data = _ref.data,
        ...
        if (code === 0) {
          if (data.length === 0) {
            // 在外卖中改的，2017-7-06
            var handleChange = _this2.props.handleChange;
    ...
    value: function handleToggleContactForm(editContact) {
      ...
      (0, _mask2.default)(_react2.default.createElement(
        ...
        _react2.default.createElement(_contactForm2.default, _extends({ editContact: editContact }, { onSuccess: this.handleFormSuccess.bind(this) }))
      ), { mask: false });
    ...
    value: function handleDeleteContact(contact) {
      ...
      alert('删除', '确定删除么?', [{ text: '取消', onPress: function onPress() {
          ...
          var handleClose = (0, _loading2.default)();
          (0, _send2.default)('/user/v1/contact', { userId: userId, contactId: contactId }, 'delete').then(function (_ref2) {
            var code = _ref2.code,
                data = _ref2.data,
    ...
    value: function handleSetContact(contact) {
      ...
      // 这里是设置默认地址
      (0, _send2.default)('/user/v1/contact', (0, _merge2.default)((0, _clone2.default)(contact), { isDefault: 1 }), 'put').then(function (_ref3) {
        var code = _ref3.code,
            data = _ref3.data,
...
var Contact = function Contact(_ref4) {
  ...
  var name = contact.name,
      ...
      gender = _contact$gender === undefined ? '' : _contact$gender,
      phone = contact.phone,
      tag = contact.tag,
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          null,
          typeof gender == 'undefined' ? '' : gender == 1 ? '女士' : '先生'
        ),
        _react2.default.createElement(
          'span',
          null,
        ...
        tag == '家' ? _react2.default.createElement(
          'span',
          null,
        ...
        ) : tag == '公司' ? _react2.default.createElement(
          'span',
          null,
          tag && _react2.default.createElement(
            'span',
        ...
        ) : tag == '学校' ? _react2.default.createElement(
          'span',
          null,
          tag && _react2.default.createElement(
            'span',
      ...
      _react2.default.createElement(
        'div',
        { className: 'addr' },
        province && _react2.default.createElement(
          'span',
          null,
          province
        ),
        county && _react2.default.createElement(
          'span',
          null,
          county
        ),
      ...
      _react2.default.createElement(
        ...
        houseNum && _react2.default.createElement(
          'span',
          null,
          houseNum
        )
