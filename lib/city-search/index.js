...
var CitySearch = function (_React$Component) {
  ...
  function CitySearch(props) {
    ...
    _this.handleCityIndexClick = _this.handleCityIndexClick.bind(_this);
    return _this;
  }
  ...
  _createClass(CitySearch, [{
            ...
            cityIndex.map(function (item, index) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'span',
                  { onClick: function onClick() {
                      return _this3.handleCityIndexClick(item);
                    } },
    ...
    key: 'handleCityIndexClick',
    value: function handleCityIndexClick(cityIndex) {
