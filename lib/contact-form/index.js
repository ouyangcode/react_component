...
require('./style/contact-form.scss');
...
var CustomerForm = function (_Component) {
  ...
  _createClass(CustomerForm, [{
    ...
    key: 'handleHouseNumChange',
    value: function handleHouseNumChange(houseNum) {
      this.setState({ houseNum: houseNum });
    }
  }, {
    ...
    value: function handleAddressChange(location) {
      ...
      gethasLocation(point, function (rightCity) {
        console.log('rightCity', rightCity);
        _this2.handleChangeArea(rightCity.province, rightCity.city, rightCity.district, true); // rightCity.county 因为没有这个参数了 而被替换为district  所以这里做了修改 2017-7-30
        var city = rightCity.city,
            province = rightCity.province,
            district = rightCity.district;
      ...
      (0, _setStore2.default)('goBackPoint', points, 'session'); // 经纬度精确问题 2017-7-06  外卖
    ...
    value: function handleSaveContact() {
      ...
      if (contactId) {
        ...
        postData = (0, _merge2.default)(this.state, _extends({}, (0, _getStore2.default)('goBackPoint', 'session'), { // 2017-7-03 修改保存时的经纬度，原本为取用本地的经纬度
          userId: (0, _getStore2.default)('customerUserId', 'session')
        }));
        console.log('SaveContact-----', (0, _getStore2.default)('goBackPoint', 'session'));
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'touch-layer hp100 contactWrap' },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              null,
              _react2.default.createElement('input', { type: 'text', placeholder: '\u8BF7\u586B\u5199\u6536\u8D27\u4EBA\u7684\u59D3\u540D', value: name,
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: 'gray ' + (gender === 0 ? 'otoOrange' : ''), onClick: function onClick() {
              ...
              _react2.default.createElement(
                'span',
                { className: 'gray ' + (gender === 1 ? 'otoOrange' : ''), onClick: function onClick() {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              null,
              _react2.default.createElement('input', { type: 'tel', maxLength: '11', placeholder: '\u8BF7\u586B\u5199\u6536\u8D27\u4EBA\u7684\u7535\u8BDD\u53F7\u7801', value: phone,
                onChange: function onChange(e) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { className: 'wp80 no-border addressSpan ' + (address ? 'addressSpan0' : ''), onClick: function onClick() {
                  _this6.handleToggleAddressSearchShow(true);
                } },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              null,
              _react2.default.createElement('input', { type: 'text', placeholder: '\u8865\u5145\u8BE6\u7EC6\u5730\u5740\uFF08\u5982\u95E8\u724C\u53F7/\u697C\u5C42\u7B49\uFF09', value: detail,
                className: 'wp80 no-border',
                onChange: function onChange(e) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              null,
              _react2.default.createElement('input', { type: 'text', placeholder: '\u4F8B\uFF1A6\u53F7\u697C205\u5BA4', value: houseNum,
                onChange: function onChange(e) {
                  return _this6.handleHouseNumChange(e.target.value);
                },
                className: 'wp80 no-border'
              })
            )
          ...
          _react2.default.createElement(
            ListItem,
            { className: 'tagList', extra: ['家', '公司', '学校'].map(function (d, i) {
                return _react2.default.createElement(
                  'span',
                  { className: 'tag ototab ' + (tag && tag === d ? 'otoOrange' : ''), key: i, onClick: function onClick() {
                      return _this6.handleTagChange(d);
                    } },
                  d
                );
              }), arrow: 'empty' },
...
// 标签组件
var LabelComponent = function LabelComponent(_ref7) {
  var handleTagChange = _ref7.handleTagChange,
      tag = _ref7.tag;
  ...
  return _react2.default.createElement(
    ...
    data.map(function (d, i) {
      return _react2.default.createElement(
        'span',
        { className: 'tag ototab' + (tag && tag === d ? 'otoOrange' : ''), key: i, onClick: handleTagChange(d) },
        d
      );
    })
  );
