...
import { clone, merge, getStore, get, send } from '@boluome/common-lib'
import { List, WhiteSpace, InputItem, Switch, Picker, Radio, Button, Toast } from 'antd-mobile'
import { Loading, AddressSearch, SlidePage, Mask } from '../'
...
class CustomerForm extends Component {
  ...
  handleSaveContact() {
    ...
    if(contactId) {
      ...
      postData = merge(this.state, {
       ...
       userId: getStore('customerUserId')
     })
    }
  ...
  //   })
  // }
  filterAreaByName (province, city, county) {
    const { provinceArr, cityArr, countyArr } = this.state
  ...
  handleChangeArea(province, city, county) {
      ...
      <div className='touch-layer hp100'>
        ...
        <List>
          ...
          <Picker extra={ `${ province } ${ city } ${ county }` }
            ...
            <ListItem arrow='horizontal' >所在地区</ListItem>
          </Picker>
          <ListItem>
