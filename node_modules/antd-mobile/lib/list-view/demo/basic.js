'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.description=exports.title=undefined;var _listView=require('antd-mobile/components/list-view');var _listView2=_interopRequireDefault(_listView);var _react=require('react');var _react2=_interopRequireDefault(_react);
...
var pageIndex=0;exports["default"]=
...
this.sectionIDs=[];
this.rowIDs=[];
this._genData=function(){var pIndex=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;
...
onEndReached:function onEndReached(_event){var _this2=this;
...
var obj=data[index--];
return _react2["default"].createElement(_reactNative.View,{key:rowID},
_react2["default"].createElement(_reactNative.TouchableHighlight,{underlayColor:'rgba(100,100,100,0.2)',style:[{
padding:8,
...
" - ",
rowID),
_react2["default"].createElement(_reactNative.Text,null,_this3.props.highlightRow),
_react2["default"].createElement(_reactNative.Text,null,
_react2["default"].createElement(_reactNative.Text,{style:[{fontSize:24,color:'#FF6E27'}]},"35"),
"元/任务"))))));


};
return _react2["default"].createElement(_listView2["default"],{dataSource:this.state.dataSource,renderHeader:function renderHeader(){return _react2["default"].createElement(_reactNative.Text,{style:[{padding:30}]},"列表头");},renderFooter:function renderFooter(){return _react2["default"].createElement(_reactNative.Text,{style:[{padding:30,textAlign:'center'}]},_this3.state.isLoading?'加载中...':'加载完毕');},renderSectionHeader:function renderSectionHeader(sectionData){return _react2["default"].createElement(_reactNative.Text,{style:[{
padding:10,color:'blue',
backgroundColor:'rgba(150, 150, 150, 0.6)'}]},'\u4EFB\u52A1 '+
sectionData.split(' ')[1]);},renderRow:row,renderSeparator:separator,pageSize:4,onEndReached:this.onEndReached,onEndReachedThreshold:10,onChangeVisibleRows:function onChangeVisibleRows(_visibleRows,_changedRows){
