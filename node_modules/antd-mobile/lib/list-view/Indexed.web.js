...
return _react2["default"].createElement(IndexedList,__assign({ref:"indexedList",sectionHeaderClassName:prefixCls+'-section-header '+listPrefixCls+'-body',sectionBodyClassName:prefixCls+'-section-body '+listPrefixCls+'-body'},restProps,extraProps),this.props.children);
