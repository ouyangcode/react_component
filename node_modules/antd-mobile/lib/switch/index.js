...
AntmSwitch=function(_React$Component){(0,_inherits3["default"])(AntmSwitch,_React$Component);
function AntmSwitch(props){(0,_classCallCheck3["default"])(this,AntmSwitch);var _this=(0,_possibleConstructorReturn3["default"])(this,
_React$Component.call(this,props));
_this.state={
checked:props.checked};return _this;
...
this.props,style=_props.style,disabled=_props.disabled;
return _react2["default"].createElement(_reactNative.Switch,{style:style,onValueChange:function onValueChange(value){_this2.onChange(value);},value:this.state.checked,disabled:disabled});
