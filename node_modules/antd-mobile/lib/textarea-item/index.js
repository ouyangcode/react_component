...
_this.props,autoHeight=_this$props.autoHeight,rows=_this$props.rows;
if(autoHeight){
...
this.props,rows=_props.rows,error=_props.error,clear=_props.clear,count=_props.count,autoHeight=_props.autoHeight,last=_props.last,onErrorClick=_props.onErrorClick;
var containerStyle={
...
return _react2["default"].createElement(_reactNative.View,{style:[_index2["default"].container,containerStyle,{position:'relative'}]},
_react2["default"].createElement(_reactNative.TextInput,__assign({style:[_index2["default"].input,textareaStyle,{height:Math.max(45,this.state.height)}],onChange:function onChange(event){return _this2.onChange(event);},value:this.state.value,multiline:rows>1||autoHeight,numberOfLines:rows,maxLength:maxLength,clearButtonMode:clear?'while-editing':'never',underlineColorAndroid:"transparent"},restProps)),
...
null,
rows>1&&count>0?_react2["default"].createElement(_reactNative.View,{style:[_index2["default"].count]},
