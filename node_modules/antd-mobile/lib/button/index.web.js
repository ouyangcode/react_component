...
return _react2["default"].createElement('span',{__source:{fileName:_jsxFileName,lineNumber:28}},child);
}
return child;
}var
...
return _react2["default"].createElement(_rcTouchable2["default"],{activeClassName:activeStyle?prefixCls+'-active':undefined,disabled:disabled,activeStyle:activeStyle,__source:{fileName:_jsxFileName,lineNumber:53}},
_react2["default"].createElement('a',(0,_extends3["default"])({role:'button',className:(0,_classnames2["default"])(wrapCls)},restProps,{onClick:disabled?undefined:onClick,'aria-disabled':disabled,__source:{fileName:_jsxFileName,lineNumber:54}}),
iconType?_react2["default"].createElement(_index2["default"],{'aria-hidden':'true',type:iconType,size:size==='small'?'xxs':'md',__source:{fileName:_jsxFileName,lineNumber:55}}):null,
kids));
