...
render=function render(){var _wrapCls;var _splitObject=
(0,_splitObject4["default"])(this.props,['children','className','prefixCls','type','size','inline','across',
'disabled','icon','loading','activeStyle']),_splitObject2=(0,_slicedToArray3["default"])(_splitObject,2),_splitObject2$=_splitObject2[0],children=_splitObject2$.children,className=_splitObject2$.className,prefixCls=_splitObject2$.prefixCls,type=_splitObject2$.type,size=_splitObject2$.size,inline=_splitObject2$.inline,across=_splitObject2$.across,disabled=_splitObject2$.disabled,icon=_splitObject2$.icon,loading=_splitObject2$.loading,activeStyle=_splitObject2$.activeStyle,restProps=_splitObject2[1];
...
_react2["default"].createElement("button",__assign({},restProps,{type:this.props.htmlType||'button',className:(0,_classnames2["default"])(wrapCls),disabled:disabled}),
