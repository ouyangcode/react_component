...
Modal=function(_React$Component){(0,_inherits3["default"])(Modal,_React$Component);
function Modal(props){(0,_classCallCheck3["default"])(this,Modal);var _this=(0,_possibleConstructorReturn3["default"])(this,
...
this.props,children=_props.children,disabled=_props.disabled,small=_props.small,closable=_props.closable,style=_props.style;
...
return!this.state.closed?_react2["default"].createElement(_reactNative.View,{style:[_index2["default"].tag,style]},
_react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPress:this.onClick},
_react2["default"].createElement(_reactNative.View,{style:[_index2["default"].wrap,sizeWrapStyle,wrapStyle]},
_react2["default"].createElement(_reactNative.Text,{style:[_index2["default"].text,sizeTextStyle,textStyle]},
children,
" "))),


closable&&!small&&!disabled&&_react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPressIn:this.onPressIn,onPressOut:this.onPressOut,onPress:this.onTagClose},
_react2["default"].createElement(_reactNative.View,{ref:function ref(component){return _this2.closeDom=component;},style:[_index2["default"].close,_reactNative.Platform.OS==='ios'?_index2["default"].closeIOS:_index2["default"].closeAndroid]},
_react2["default"].createElement(_reactNative.Text,{style:[_index2["default"].closeText,_reactNative.Platform.OS==='android'?_index2["default"].closeTransform:{}]},"×")))):
