...
var _getDataAttr=require('../_util/getDataAttr');var _getDataAttr2=_interopRequireDefault(_getDataAttr);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}var __assign=undefined&&undefined.__assign||Object.assign||function(t){for(var s,i=1,n=arguments.length;i<n;i++){s=arguments[i];for(var p in s){if(Object.prototype.hasOwnProperty.call(s,p))t[p]=s[p];}}return t;};var
...
prefixCls+'-normal',!this.state.selected&&!disabled),(0,_defineProperty3["default"])(_classNames,
prefixCls+'-active',this.state.selected&&!disabled),(0,_defineProperty3["default"])(_classNames,
prefixCls+'-disabled',disabled),_classNames));

return!this.state.closed?_react2["default"].createElement("div",__assign({},(0,_getDataAttr2["default"])(this.props),{className:wrapCls,onClick:this.onClick,style:style}),
_react2["default"].createElement("div",{className:prefixCls+'-text'},children),
closable&&!disabled&&!small&&_react2["default"].createElement("div",{className:prefixCls+'-close',onClick:this.onTagClose},
