...
case NORMAL:
mode='normal';
children=_react2["default"].createElement("div",__assign({},(0,_getDataAttr2["default"])(props)),
titleMsg,
_react2["default"].createElement("div",{className:prefixCls+'-button-list'},options.map(function(item,index){var _cls;
...
_react2["default"].createElement("div",__assign({},itemProps),item));
...
_react2["default"].createElement("div",__assign({},itemProps),
item,
...
_react2["default"].createElement("div",{className:prefixCls+'-share-list-item-icon'},item.iconName?_react2["default"].createElement(_index2["default"],{type:item.iconName}):item.icon),
...
multipleLine?options.map(function(item,index){return _react2["default"].createElement("div",{key:index,className:prefixCls+'-share-list'},item.map(function(ii,ind){return createList(ii,ind,index);}));}):_react2["default"].createElement("div",{className:prefixCls+'-share-list'},options.map(function(item,index){return createList(item,index);})),
_react2["default"].createElement(_rcTouchable2["default"],{activeClassName:prefixCls+'-share-cancel-button-active'},
_react2["default"].createElement("div",{className:prefixCls+'-share-cancel-button',onClick:function onClick(){return cb(-1);}},cancelButtonText))));
