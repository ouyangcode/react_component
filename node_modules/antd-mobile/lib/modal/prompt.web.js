...
_react2["default"].createElement("input",{type:"text",defaultValue:defaultValue,ref:function ref(input){return setTimeout(function(){
if(input){
input.focus();
}
...
inputDom=_react2["default"].createElement("div",null,
_react2["default"].createElement("div",{className:prefixCls+'-input'},
_react2["default"].createElement("input",{type:"password",defaultValue:"",ref:function ref(input){return setTimeout(function(){
if(input){
input.focus();
}
},500);},onChange:onChange})));
