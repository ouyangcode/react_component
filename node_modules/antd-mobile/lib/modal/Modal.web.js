...
_react2["default"].createElement("a",{className:prefixCls+'-button',style:buttonStyle,href:"#",onClick:function onClick(e){
e.preventDefault();
if(button.onPress){
button.onPress();
}
...
this.props,prefixCls=_props.prefixCls,className=_props.className,transparent=_props.transparent,animated=_props.animated,transitionName=_props.transitionName,maskTransitionName=_props.maskTransitionName,style=_props.style,_props$footer=_props.footer,footer=_props$footer===undefined?[]:_props$footer;
...
prefixCls+'-transparent',transparent),_classNames));
...
var footerDom=footer.length?_react2["default"].createElement("div",{className:btnGroupClass},footer.map(function(button,i){return _this2.renderFooterButton(button,prefixCls,i);})):null;
