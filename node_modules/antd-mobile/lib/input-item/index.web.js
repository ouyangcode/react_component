...
return _react2["default"].createElement('div',{className:wrapCls,style:style,__source:{fileName:_jsxFileName,lineNumber:171}},
children?_react2["default"].createElement('div',{className:labelCls,__source:{fileName:_jsxFileName,lineNumber:172}},children):null,
_react2["default"].createElement('div',{className:controlCls,__source:{fileName:_jsxFileName,lineNumber:173}},
_react2["default"].createElement(_Input2["default"],(0,_extends3["default"])({},patternProps,otherProps,valueProps,classNameProps,{type:inputType,maxLength:maxLength,name:name,placeholder:placeholder,onChange:this.onInputChange,onFocus:this.onInputFocus,onBlur:this.onInputBlur,readOnly:!editable,disabled:disabled,__source:{fileName:_jsxFileName,lineNumber:174}}))),

clear&&editable&&!disabled&&value&&value.length>0?
_react2["default"].createElement('div',{className:prefixCls+'-clear',onClick:this.clearInput,__source:{fileName:_jsxFileName,lineNumber:177}}):
null,
error?_react2["default"].createElement('div',{className:prefixCls+'-error-extra',onClick:this.onErrorClick,__source:{fileName:_jsxFileName,lineNumber:179}}):null,
extra!==''?_react2["default"].createElement('div',{className:prefixCls+'-extra',onClick:this.onExtraClick,__source:{fileName:_jsxFileName,lineNumber:180}},extra):null);
