...
_this.state={
focus:false,
placeholder:_this.props.placeholder};return _this;
...
'updatePlaceholder']);var _state=

this.state,focus=_state.focus,placeholder=_state.placeholder;
...
var controlCls=(0,_classnames2["default"])((_classNames3={},(0,_defineProperty3["default"])(_classNames3,
prefixCls+'-control',true),(0,_defineProperty3["default"])(_classNames3,
prefixCls+'-control-android',this.isAndroid),_classNames3));
...
_react2["default"].createElement("input",__assign({ref:"input"},patternProps,otherProps,valueProps,{type:inputType,maxLength:maxLength,name:name,placeholder:placeholder,onChange:this.onInputChange,onBlur:this.onInputBlur,onFocus:this.onInputFocus,readOnly:!editable,disabled:disabled}))),
