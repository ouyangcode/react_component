...
return _react2["default"].createElement("div",{className:this.props.prefixCls+'-wrapper'},
_react2["default"].createElement(_rcSlider2["default"],__assign({},this.props)));

};return Slider;}(_react2["default"].Component);exports["default"]=Slider;

Slider.defaultProps={
prefixCls:'am-slider',
tipTransitionName:'zoom-down'};module.exports=exports['default'];