...
this.props,text=_props.text,prefixCls=_props.prefixCls,overflowCount=_props.overflowCount,className=_props.className,style=_props.style,children=_props.children;
...
children,
!hidden&&
_react2["default"].createElement("sup",{className:scrollNumberCls,style:style},text));
