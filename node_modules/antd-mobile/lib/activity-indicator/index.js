...
_react2["default"].createElement(_reactNative.View,{style:[_style2["default"].innerContainer,{height:89}]},
_react2["default"].createElement(_reactNative.View,{style:[_style2["default"].wrapper]},
_react2["default"].createElement(_reactNative.ActivityIndicator,{color:"white",size:"large"}),
this.props.text&&_react2["default"].createElement(_reactNative.Text,{style:[_style2["default"].toast]},this.props.text))));
...
this.props.text&&_react2["default"].createElement(_reactNative.Text,{style:[_style2["default"].tip]},this.props.text));
};RNActivityIndicator.prototype.
