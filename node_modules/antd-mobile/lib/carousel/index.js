'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _extends2=require('babel-runtime/helpers/extends');var _extends3=_interopRequireDefault(_extends2);var _classCallCheck2=require('babel-runtime/helpers/classCallCheck');var _classCallCheck3=_interopRequireDefault(_classCallCheck2);var _possibleConstructorReturn2=require('babel-runtime/helpers/possibleConstructorReturn');var _possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2);var _inherits2=require('babel-runtime/helpers/inherits');var _inherits3=_interopRequireDefault(_inherits2);var _jsxFileName='/Users/temupsc/git/antd/ant-design-mobile/components/carousel/index.jsx';var _react=require('react');var _react2=_interopRequireDefault(_react);
var _pagination=require('../pagination');var _pagination2=_interopRequireDefault(_pagination);
var _reactNative=require('react-native');
var _style=require('./style');var _style2=_interopRequireDefault(_style);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}
var defaultPagination=function defaultPagination(props){var
styles=props.styles,current=props.current,vertical=props.vertical,count=props.count;
var positionStyle=vertical?'paginationY':'paginationX';
var flexDirection=vertical?'column':'row';
return _react2["default"].createElement(_pagination2["default"],{style:[styles.pagination,styles[positionStyle]],indicatorStyle:{flexDirection:flexDirection},current:current,mode:'pointer',total:count,__source:{fileName:_jsxFileName,lineNumber:9}});
};var
...
var pages=[];
if(!children){
return _react2["default"].createElement(_reactNative.Text,{style:{backgroundColor:'white'},__source:{fileName:_jsxFileName,lineNumber:199}},'You are supposed to add children inside Carousel');
...
return _react2["default"].createElement(_reactNative.View,{style:pageStyle,key:i,__source:{fileName:_jsxFileName,lineNumber:213}},children[page]);
});
}else
{
pages=_react2["default"].createElement(_reactNative.View,{style:pageStyle,__source:{fileName:_jsxFileName,lineNumber:217}},children);
}
return _react2["default"].createElement(_reactNative.View,{onLayout:this.onLayout,__source:{fileName:_jsxFileName,lineNumber:219}},
...
pagination:defaultPagination};exports["default"]=
