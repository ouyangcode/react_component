...
this.props,prefixCls=_props2.prefixCls,enabled=_props2.enabled,tintColor=_props2.tintColor;
...
return _react2["default"].createElement(_rcTouchable2["default"],{key:idx,disabled:!enabled,activeClassName:prefixCls+'-item-active'},
_react2["default"].createElement("div",{className:itemCls,style:{
color:selected?'#fff':tintColor,
backgroundColor:selected?tintColor:'#fff',
borderColor:tintColor},
onClick:!enabled?undefined:function(e){return _this2.onClick(e,idx,value);}},
...
this.props,className=_props3.className,prefixCls=_props3.prefixCls,style=_props3.style,enabled=_props3.enabled,_props3$values=_props3.values,values=_props3$values===undefined?[]:_props3$values;
...
prefixCls+'-disabled',!enabled),_classNames2));

return _react2["default"].createElement("div",{className:wrapCls,style:style},values.map(function(value,idx){return _this3.renderSegmentItem(idx,value,idx===_this3.state.selectedIndex);}));
