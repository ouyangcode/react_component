...
if(titleFixed){
table=_react2["default"].createElement(_rcTable2["default"],__assign({},newProps,{columns:columns,scroll:{x:true},showHeader:false}));
}else
{
table=_react2["default"].createElement(_rcTable2["default"],__assign({},newProps,{columns:columns,scroll:{x:scrollX}}));
}
}else
if(direction==='horizon'){
columns[0].className=prefixCls+'-horizonTitle';
table=_react2["default"].createElement(_rcTable2["default"],__assign({},newProps,{columns:columns,showHeader:false,scroll:{x:scrollX}}));
}else
if(direction==='mix'){
columns[0].className=prefixCls+'-horizonTitle';
table=_react2["default"].createElement(_rcTable2["default"],__assign({},newProps,{columns:columns,scroll:{x:scrollX}}));
