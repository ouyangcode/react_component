...
this.props,style=_props.style,children=_props.children,flex=_props.flex,onPress=_props.onPress;
var flexItemStyle={
flex:flex||1};

return _react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPress:onPress},
_react2["default"].createElement(_reactNative.View,{style:[flexItemStyle,style]},children));
