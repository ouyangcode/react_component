...
imgItemList,
selectable&&_react2["default"].createElement(_rcTouchable2["default"],{activeClassName:prefixCls+'-upload-btn-active'},
_react2["default"].createElement("div",{className:prefixCls+'-item '+prefixCls+'-upload-btn',style:itemStyle,onClick:function onClick(){
if(onAddImageClick){
onAddImageClick();
}
}},!onAddImageClick?_react2["default"].createElement("input",{style:itemStyle,ref:"fileSelectorInput",type:"file",accept:"image/jpg,image/jpeg,image/png,image/gif",onChange:function onChange(){_this2.onFileChange();}}):null))))));
