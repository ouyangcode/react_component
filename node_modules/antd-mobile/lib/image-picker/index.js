...
files.map(function(item,index){return _react2["default"].createElement(_reactNative.View,{key:index,style:[styles.item,styles.size]},
...
_react2["default"].createElement(_reactNative.Text,{style:styles.closeText},"×"))));}),
...
this.state.visible?_react2["default"].createElement(_ImageRoll2["default"],{onCancel:this.hideImageRoll,onSelected:function onSelected(imgObj){return _this2.addImage(imgObj);}}):null);
