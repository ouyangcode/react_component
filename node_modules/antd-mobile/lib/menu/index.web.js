...
_react2["default"].createElement(_list2["default"],null,data.map(function(dataItem,index){return _react2["default"].createElement(_list2["default"].Item,{className:dataItem.value===firstLevelSelectValue?prefixCls+'-selected':'',onClick:function onClick(){return _this2.onClickFirstLevelItem(dataItem);},key:'listitem-1-'+index},dataItem.label);}))):
null,
