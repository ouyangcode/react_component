...
if(content){
newChildren.push(_react2["default"].createElement(_reactNative.View,{key:idx,style:[
styles.contentItem,
...
_react2["default"].createElement(_reactNative.View,{style:styles.content},this.getPanes(true)),
_react2["default"].createElement(_reactNative.View,{style:[styles.tabs,{backgroundColor:this.props.barTintColor}]},this.getPanes(false)));
