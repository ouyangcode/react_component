...
onPress:function onPress(){return onClick(el,dataIndex);}},renderItem(el,dataIndex)));
}else
{
rowArr.push(_react2["default"].createElement(_flex2["default"].Item,{key:j,style:[styles.grayBorderBox,flexItemStyle]}));
}};for(var j=0;j<columnNum;j++){_loop(j);
}
rowsArr.push(_react2["default"].createElement(_flex2["default"],{key:i,style:[styles.grayBorderBox,{
...
pageRows.push(_react2["default"].createElement(_flex2["default"],{key:rowIndex,style:[styles.grayBorderBox,{borderBottomWidth:hasLine?1:0}]},res));
}
}
pagesArr.push(_react2["default"].createElement(_reactNative.View,{key:pageIndex,style:[styles.grayBorderBox,{
