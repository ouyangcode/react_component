...
render=function render(){var _classNames;var _splitObject=
(0,_splitObject4["default"])(this.props,['prefixCls','children','mode','className',
'iconName','leftContent','rightContent','onLeftClick']),_splitObject2=(0,_slicedToArray3["default"])(_splitObject,2),_splitObject2$=_splitObject2[0],prefixCls=_splitObject2$.prefixCls,children=_splitObject2$.children,mode=_splitObject2$.mode,className=_splitObject2$.className,iconName=_splitObject2$.iconName,leftContent=_splitObject2$.leftContent,rightContent=_splitObject2$.rightContent,onLeftClick=_splitObject2$.onLeftClick,restProps=_splitObject2[1];
...
return _react2["default"].createElement("div",__assign({},restProps,{className:wrapCls}),
_react2["default"].createElement("div",{className:prefixCls+'-left',onClick:onLeftClick},
iconName?_react2["default"].createElement("span",{className:prefixCls+'-left-icon'},
...
_react2["default"].createElement("div",{className:prefixCls+'-right'},rightContent));
