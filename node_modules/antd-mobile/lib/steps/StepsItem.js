...
this.props,size=_props.size,current=_props.current,index=_props.index,last=_props.last,title=_props.title,description=_props.description,status=_props.status,errorTail=_props.errorTail,icon=_props.icon;
var iconImg=void 0;
var headCls=void 0;
...
return _react2["default"].createElement(_reactNative.View,{style:{flex:1,flexDirection:'row'}},
_react2["default"].createElement(_reactNative.View,{style:{flexDirection:'column'}},
_react2["default"].createElement(_reactNative.View,{style:[_style2["default"]['head_default'+sizeCls],_style2["default"][headCls]]},
...
_react2["default"].createElement(_reactNative.View,{style:_style2["default"]['content'+sizeCls]},
_react2["default"].createElement(_reactNative.Text,{style:[_style2["default"]['title'+sizeCls]]},title),
_react2["default"].createElement(_reactNative.Text,{style:[_style2["default"]['description'+sizeCls]]},description)));
