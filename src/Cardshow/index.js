...
class CardShow extends Component {
  ...
  render() {
    const { nameTitle = '', startTime = '', durationTime = '', endTime = '', textArr = [], startDate = '', endDate = '', imgIcon = '', addressStr = '' } = this.state.openCard
    return (
        ...
        <div className='orderCard'>
          ...
          <div className='ordertime'>
            ...
            <div className='jobtime'>
              <img alt='加载中' src={ imgIcon } />
              <span>{ durationTime ? `营业时间长, ${ durationTime }` : '商家暂未提供具体时间' }</span>
              { durationTime ? (<span style={{ color: '#fff' }} >不许去掉</span>) : (<span >请联系：10106060</span>) }
            </div>
